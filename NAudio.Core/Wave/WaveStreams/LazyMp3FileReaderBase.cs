...
namespace NAudio.Wave
{
    ...
    /// </summary>
    public class LazyMp3FileReaderBase : WaveStream
    {
        ...
        public LazyMp3FileReaderBase(string mp3FileName, FrameDecompressorBuilder frameDecompressorBuilder)
        ...
        /// <param name="frameDecompressorBuilder">Factory method to build a frame decompressor</param>
        public LazyMp3FileReaderBase(Stream inputStream, FrameDecompressorBuilder frameDecompressorBuilder)
            : this(inputStream, frameDecompressorBuilder, false)
        {

        }

        protected LazyMp3FileReaderBase(Stream inputStream, FrameDecompressorBuilder frameDecompressorBuilder, bool ownInputStream)
        {
            ...
            lock (repositionLock)
            {
                ...
                while (bytesRead < numBytes)
                {
                    ...
                    if (frame != null)
                    {
                        ...
                        else if (decompressed == bytesPerDecodedFrame * 2)
                        {
